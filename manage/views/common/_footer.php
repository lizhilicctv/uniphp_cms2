...
<script type="text/javascript" src="<?php echo APP_CONFIG['__manage__']; ?>lib/layer/2.4/layer.js"></script>
<script type="text/javascript" src="<?php echo APP_CONFIG['__manage__']; ?>static/h-ui/js/H-ui.min.js"></script>
<script type="text/javascript" src="<?php echo APP_CONFIG['__manage__']; ?>static/h-ui.admin/js/H-ui.admin.js"></script> 
